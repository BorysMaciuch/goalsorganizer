...
export const addGoal = (
  ...
  axios
    .post("https://goalsorganizer.herokuapp.com/add-goal", {
      id,
      title: goalTitle,
      actionPoints: [],
      userId,
...
export const deleteGoal = (
  ...
  axios
    .delete(`https://goalsorganizer.herokuapp.com/delete-goal/${id}`)
    .catch((err) => console.log(err));
};
...
export const editGoal = (
  ...
  axios
    .patch(`https://goalsorganizer.herokuapp.com/edit-goal/${goalId}`, {
...
export const addActionPoint = (
  ...
  axios
    .patch(`https://goalsorganizer.herokuapp.com/add-goal/${id}`, {
...
export const deleteActionPoint = (
  ...
  axios
    .post(`https://goalsorganizer.herokuapp.com/delete-action-point/${id}`, {
      goalId: goalId,
    })
    .catch((err) => console.log(err));
};
export const editActionPoint = (
  ...
  axios
    .patch(`https://goalsorganizer.herokuapp.com/edit-action-point/${id}`, {
      goalId: goalId,
      description: description,
    })
    .catch((err) => console.log(err));
